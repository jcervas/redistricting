...
geo.counties <- rgdal::readOGR("/Users/user/Google Drive/GitHub/Data Files/GIS/Tigerline/2020/counties/tl_2020_us_county.shp")
	TN_geo.counties <- geo.counties[geo.counties@data$STATEFP %in% "47",]
	TN_geo.counties.tmp <- TN_geo.counties

TN_geo.blkgrps <- rgdal::readOGR("/Users/user/Google Drive/GitHub/Data Files/GIS/Tigerline/2020/blockgroups/47/tl_2020_47_bg.shp")
	TN_geo.blkgrps.tmp <- TN_geo.blkgrps
...
TN_geo.vtd <- rgdal::readOGR("/Users/user/Google Drive/GitHub/Data Files/Census/TN2020.pl/GIS/vtd/TN_vtd20.shp")
	TN_geo.vtd.tmp <- TN_geo.vtd

plans <- c("TN_2022_House_Enacted", 
	"TN_House_Dem_Concept", 
	"TN_Split_Ensemble_3_0_478",
	"TN_Split_Ensemble_3_2_13700",
	"TN_Split_Ensemble_3_4_5500",
	"TN_Split_Ensemble_3_1_2400",
	"TN_Split_Ensemble_3_1_7500",
	"TN_Split_Ensemble_3_5_10428")


		cols <- function(x, colors=NULL) {
			if (is.null(colors)) {
				colors <- c("#A6CEE3", "#1F78B4", "#FFFF99", "#FF7F00", "#ADDD8E", "#B2DF8A", "#2b51a1", "#f9f934", "#f75167", "#80B1D3", "#FB8090", "#8dd3c7", "#ADDD8E", "#fdb462", "#FDDBC7", "#00B0F0", "#70AD47", "#305496", "#bc80bd", "#fb8072", "#e31a1c", "#3182BD", "#fdbf6f", "#ffff99", "#FF7F00", "#a6cee3")
			}
			x.uniq <- sort(unique(x))
			return(
				cbind.data.frame(
					District = x.uniq,
					colors = rep(colors, length(x.uniq))[1:length(x.uniq)]
					))
			}
...
Measuring plans using these three different notions allow for comparisons any plan equally. *[Table 1](#tab-1)* does this for the 2012-2020 enacted map, the 2022-2030 enacted map, and the House Democratic Concept map. The 2022 enacted map scores the worst across all three measures.
...
<!-- ```{r}
	...
	plans.tmp <- read.csv(paste0("/Users/user/Google Drive/Projects/Redistricting/2022/TN/Plans/TN Split Ensemble/TN Split Ensemble 3 - FINAL REPORT/TN_2022_House_Enacted.csv"), colClasses=c("character"))
	...
	plot(vtd.tmp, col = vtd.tmp@data$colors, border = vtd.tmp@data$colors, lty=1, lwd = 0.5)
	plot(TN_geo.counties.tmp, border="gray20", lwd=1, add=T)
...
### Figure 6 - Ensemble Plan 3_0_47 {#fig-3_0_47}
![](Maps/TN_Split_Ensemble_3_0_478.png)
...
### Figure 7 - Ensemble Plan 3_1_2400 {#fig-3_1_2400}
![](Maps/TN_Split_Ensemble_3_1_2400.png)
...
### Figure 8 - Ensemble Plan 3_1_7500 {#fig-3_1_7500}
![](Maps/TN_Split_Ensemble_3_1_7500.png)
...
### Figure 9 - Ensemble Plan 3_2_13700 {#fig-3_2_13700}
![](Maps/TN_Split_Ensemble_3_2_13700.png)
...
### Figure 10 - Ensemble Plan 3_4_5500 {#fig-3_4_5500}
![](Maps/TN_Split_Ensemble_3_4_5500.png)
...
### Figure 11 - Ensemble Plan 3_5_10428 {#fig-3_5_10428}
![](Maps/TN_Split_Ensemble_3_5_10428.png)
